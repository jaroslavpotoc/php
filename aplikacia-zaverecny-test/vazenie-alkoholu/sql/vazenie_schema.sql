...
INSERT INTO `udaje_tovar` (`id`, `ean_kod`, `nazov`, `merna_jednotka`, `cela_flasa`, `prazdna_flasa`,
                           `vaha_jednej_davky`, `datum`, `cas`)
VALUES (1, '5029578000972', 'Old Jamaica Ginger Beer 0,33l', 'ks', NULL, NULL, NULL, '2023-06-26', '00:00:00'),
       ...
       (18, '8588004339118', 'Repa Winery - Pinot Pink Jeruzalem 0,75', 'l', 1163, 430, 97.7333, '2023-06-26',
        '00:00:00'),
       (19, '8586000542402', 'Víno Rozlievané Červené 0,75l', 'l', 1246, 515, 97.4667, '2023-06-26', '00:00:00'),
       (20, '7804330311101', 'Santa Rita - Cabernet Sauvignon 120 0,75l', 'l', 1246, 515, 97.4667, '2023-06-26',
        '00:00:00'),
       (21, '9005511030875', 'Repa Winery - Veltlínske zelené 0,75l', 'l', 1184, 452, 97.6000, '2023-06-26',
        '00:00:00'),
       ...
       (26, '8016861168294', 'Masottina - Superiore DOCG Brut 0,75l ', 'ks', NULL, NULL, NULL, '2023-06-26',
        '00:00:00'),
       (27, '8016861173120', 'Masottina - R.D.O. Ponente DOCG 2020 Brut 0,75l', 'ks', NULL, NULL, NULL, '2023-06-26',
        '00:00:00'),
       (28, '8016861168386', 'Masottina - Calmaggiore DOC Treviso Extra Dry 0,75l', 'l', 1550, 794, 100.8000,
        '2023-06-26', '00:00:00'),
...
INSERT INTO `users` (`id`, `login`, `password`, `email`, `user_role`)
VALUES (1, 'test', 'test', 'test@test.sk', 'admin'),
